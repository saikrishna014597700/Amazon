...
export default class customerAddresses extends Component {
  ...
  async saveAddress(id) {
    ...
    if (document.forms[id].reportValidity()) {
      ...
      await axios
        .post(
          `${Env.host}/api/customerDetails/saveCustomerAddresses/?userId=` +
  ...
  async deleteAddress(id) {
    ...
    await axios
      .post(
        `${Env.host}/api/customerDetails/deleteCustomerAddress/?userId=` +
          localStorage.getItem("id"),
        selectedAddress
      )
      .then(async (res) => {
  ...
  async componentDidMount() {
    ...
    await axios
      .get(
        `${Env.host}/api/customerDetails/getCustomerAddresses/?userId=` + data
      )
      .then((res) => {
        console.log("addresses::", res.data);
        this.setState({
          ...
          <div className="card">
            <div className="card-header">
              <p>
                ...
                <button
                  className="Amazon"
                  onClick={(e) => this.editAddress(address._id)}
            ...
            <div className="card-body" style={{ marginLeft: "5px" }}>
              <form id={address._id}>
                  ...
                  <div className="col-sm">
                    ...
                    <div className="form-group">
                      <input
                        ...
                        disabled={!address.editFlag}
                        onChange={(e) =>
                          this.handleChange(e, address._id, "name")
                        }
                      />
                    </div>
                    <p style={{ marginBottom: "0px", marginTop: "3px" }}>
                    ...
                    <div className="form-group">
                      <input
                        ...
                        disabled={!address.editFlag}
                        onChange={(e) =>
                          this.handleChange(e, address._id, "street2")
                        }
                      />
                    </div>
                    <p style={{ marginBottom: "0px", marginTop: "3px" }}>
                    ...
                    <div className="form-group">
                      <input
                        ...
                        required
                        onChange={(e) =>
                          this.handleChange(e, address._id, "state")
                        }
                      />
                    </div>
                    <p style={{ marginBottom: "0px", marginTop: "3px" }}>
                    ...
                    <div className="form-group">
                      <input
                        ...
                        disabled={!address.editFlag}
                        onChange={(e) =>
                          this.handleChange(e, address._id, "country")
                        }
                      />
                    </div>
                  </div>
                  <div className="col-sm">
                    ...
                    <div className="form-group">
                      <input
                        ...
                        disabled={!address.editFlag}
                        onChange={(e) =>
                          this.handleChange(e, address._id, "street1")
                        }
                      />
                    </div>
                    <p style={{ marginBottom: "0px", marginTop: "3px" }}>
                    ...
                    <div className="form-group">
                      <input
                        ...
                        disabled={!address.editFlag}
                        onChange={(e) =>
                          this.handleChange(e, address._id, "city")
                        }
                      />
                    </div>
                    <p style={{ marginBottom: "0px", marginTop: "3px" }}>
                    ...
                    <div className="form-group">
                      <input
                        ...
                        disabled={!address.editFlag}
                        onChange={(e) =>
                          this.handleChange(e, address._id, "zip_code")
                        }
                      />
                    </div>
                    <p style={{ marginBottom: "0px", marginTop: "3px" }}>
                    ...
                    <div className="form-group">
                      <input
                        ...
                        pattern="[\d]{10}"
                        required
                        defaultValue={address.phoneNo}
                        disabled={!address.editFlag}
                        onChange={(e) =>
                          this.handleChange(e, address._id, "phoneNo")
                        }
                      />
                    </div>
                  </div>
                ...
                <button
                  hidden={!address.editFlag}
                  className="Amazon"
                  onClick={(e) => this.cancelAddress()}
                ...
                <button
                  hidden={!address.editFlag}
                  className="Amazon"
                  onClick={(e) => this.saveAddress(address._id)}
                  style={{
                    float: "right",
                    marginBottom: "5px",
                    marginRight: "5px",
